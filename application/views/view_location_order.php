...
<?php
    $data = array('title'=>'Location Order');
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Location Order #: <?php echo $transfer_id; ?> <a href="<?php echo base_url(); ?>index.php/inventory/product_transfers/<?php echo $source .'/'. $source_name; ?>" class="btn btn-primary">Back</a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /. header row -->
