...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Customer Waybill</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-8">
                                    <form role="form">
                                        ...
                                        <div class="form-group" id="destinationDiv">
                                            ...
                                            <input class="form-control" name="customer_name" placeholder="Enter Customer Name" value="<?php echo set_value('customer_name') ?>" id="destination">
                                        </div>
